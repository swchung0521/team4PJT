...
import com.green.team4.vo.bs.Search;
...
public class BoardController {
    ...
    @GetMapping("/list")
    public void list(Model model, Search search) {
        PageMaker pageMaker = new PageMaker(search, boardService.getTotal(search));
        log.info("list로 이동....");
        model.addAttribute("items", boardService.getPageList(search));
